// Auto-generated by assemble_algorithm.py — do not edit by hand.
// Source: adaptive_js_v4/
...
impl EffortConfig {
    pub fn default_effort() -> Self {
        Self { job_shop_iters: 10000, hybrid_flow_shop_iters: 2000, fjsp_medium_iters: 2000, fjsp_high_iters: 2000, run_forever: false }
    }
    ...
    pub fn with_run_forever(mut self, v: bool) -> Self {
        self.run_forever = v;
        self
    }
}
...
// ============================================================
// hybrid_flow_shop (submodule)
// ============================================================
mod hybrid_flow_shop {
    use super::*;
    use anyhow::{anyhow, Result};
    use rand::{rngs::SmallRng, Rng, SeedableRng};
...
// ============================================================
// solve_challenge (from solver.rs)
// ============================================================
...
fn parse_effort(hyperparameters: &Option<Map<String, Value>>) -> EffortConfig {
    ...
    if let Some(map) = hyperparameters {
        ...
        if let Some(Value::Bool(b)) = map.get("run_forever") {
            cfg = cfg.with_run_forever(*b);
        }
    }
    cfg
}
...
pub fn help() {
    ...
    println!("  run_forever:             bool,    default false   (repeat the main search+refine pipeline until external timeout)");
    println!();
    println!("NOTES:");
    ...
    println!("  When run_forever=true, the full track pipeline (restarts + refinement + local search) repeats;");
    println!("  stagnation counters carry across passes. Flow shop also repeats reentrant GRASP + tail LS/IG.");
}
