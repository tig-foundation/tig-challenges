...
pub fn help() {
    ...
    println!("  run_forever:             bool,    default false   (ignore iter limits; run until killed by external timeout)");
    println!();
    println!("NOTES:");
    ...
    println!("  When run_forever=true, all tracks loop indefinitely; the late-phase logic is disabled.");
}
