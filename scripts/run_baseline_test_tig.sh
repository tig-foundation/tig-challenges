...
#   RUN_STAMP        Date-time suffix for RUN_ROOT (default: local YYYY-MM-DD_HH-MM-SS).
#   RUN_ROOT         Output root directory (default runs/baseline_test_t${TIMEOUT}_${RUN_STAMP}).
#
...
RUN_ROOT="${RUN_ROOT:-$ROOT_DIR/runs/baseline_test_t${TIMEOUT}_${RUN_STAMP}}"
